...
export const QUERYLIST = gql`
  query QUERYLIST($sendAt: String, $status: String, $barcode: String) {
    SearchHalveForCut(sendAt: $sendAt, status: $status, barcode: $barcode) {
      id
      beeftype {
        code
        nameTH
          ...
          >
            ...
            <div className="mb-3" style={{ margin: "auto" }}>
              ...
              >
                ...
                <option value="a1">ซากซ้าย</option>
                <option value="a2">ซากขวา</option>
              </select>
              เกรด : {}
              <select
              ...
              >
                <option value="">ทั้งหมด</option>
                <option value="5f1155b2f34d6036d0515e3e">รอตัดแต่ง</option>
                <option value="5f1155c0f34d6036d0515e3f">ตัดแต่งแล้ว</option>
              </select>
            </div>
            ...
            <div>
              <Table striped bordered responsive hover style={{ margin: "auto" }}>
                ...
                <tbody>
                  {data &&
                    data.SearchHalveForCut.map((prod) =>
