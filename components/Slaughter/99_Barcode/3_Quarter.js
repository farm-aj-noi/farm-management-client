  ...
  return (
    <>
      <div style={{ display: "none" }}>
        {data && data.SlipQuarter ? (
          <Mydoc ref={componentRef} prod={data.SlipQuarter} />
        ) : (
          ""
        )}
      </div>
      {autoprint && barcode && data && data.SlipQuarter ? (
        handlePrint()
      ) : barcode && data && data.SlipQuarter ? (
        // data ? (
