      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {dayjs(prod.MFG).add(543, "y").locale("th").format("DD/MM/YYYY")}
            </label>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              {dayjs(prod.BBE).add(543, "y").locale("th").format("DD/MM/YYYY")}
            </label>
          </div>
        </div>
  ...
  return (
    <>
      <div style={{ display: "none" }}>
        {data && data.SlipChop ? (
          <Mydoc ref={componentRef} prod={data.SlipChop} />
        ) : (
          ""
        )}
      </div>
      {autoprint && barcode && data && data.SlipChop ? (
        handlePrint()
      ) : barcode && data && data.SlipChop ? (
        // data ? (
