...
export const QUERYLIST = gql`
  query QUERYLIST($createdAt: String, $barcode: String) {
    SearchLumpForSent(createdAt: $createdAt, barcode: $barcode) {
      id
      beeftype {
        nameTH
      }
              ...
              >
                ...
                <tbody>
                  {data &&
                    ...
                    data.SearchLumpForSent.map((prod) =>
