...
import Pdf from "./report_paper/6_Chop";
import Excel from "./report_excel/6_Chop";
...
export const QUERY = gql`
  query QUERY($startdate: String, $enddate: String) {
    Reportchop(startdate: $startdate, enddate: $enddate) {
      barcode
      beeftype {
        nameTH
      }
        ...
        <>
          ...
          >
            ...
            <DivFromDown>
              ...
              >
                {data && data.Reportchop.length > 0 ? (
                  <div>
                    <Pdf prod={data.Reportchop} />{" "}
                    <Excel prod={data.Reportchop} />{" "}
                  </div>
                ) : (
                  ""
                )}
