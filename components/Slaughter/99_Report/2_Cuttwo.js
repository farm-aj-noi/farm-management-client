...
export const QUERY = gql`
  query QUERY($startdate: String, $enddate: String) {
    Reportcuttwo(startdate: $startdate, enddate: $enddate) {
      imslaughter {
        numkun
        namefarmer
      }
          ...
          >
            ...
            <DivFromDown>
              <div style={{ margin: "auto", minWidth: "100%", float: "right" , marginBottom:"15px"}}>
                {data && data.Reportcuttwo.length > 0 ? (
                  <div>
                  <Pdf prod={data.Reportcuttwo} /> <Excel prod={data.Reportcuttwo} />{" "}
                </div>
                ) : (
                  ""
                )}
