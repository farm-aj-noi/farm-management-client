...
import Pdf from "./report_paper/4_Quarter";
import Excel from "./report_excel/4_Quarter";
...
export const QUERY = gql`
  query QUERY($startdate: String, $enddate: String) {
    Reportquarter(startdate: $startdate, enddate: $enddate) {
      barcode
      beeftype {
        nameTH
      }
        ...
        <>
          ...
          >
            ...
            <DivFromDown>
              ...
              >
                {data && data.Reportquarter.length > 0 ? (
                  <div>
                    <Pdf prod={data.Reportquarter} />{" "}
                    <Excel prod={data.Reportquarter} />{" "}
                  </div>
                ) : (
                  ""
                )}
