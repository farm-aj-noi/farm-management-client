...
import Pdf from "./report_paper/5_Lump";
import Excel from "./report_excel/5_Lump";
...
export const QUERY = gql`
  query QUERY($startdate: String, $enddate: String) {
    Reportlump(startdate: $startdate, enddate: $enddate) {
      barcode
		beeftype{
			nameTH
		}
          ...
          >
            ...
            <DivFromDown>
              <div style={{ margin: "auto", minWidth: "100%", float: "right" , marginBottom:"15px"}}>
                {data && data.Reportlump.length > 0 ? (
                  <div>
                  <Pdf prod={data.Reportlump} /> <Excel prod={data.Reportlump} />{" "}
                </div>
                ) : (
                  ""
                )}
