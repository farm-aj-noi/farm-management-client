  ...
  const buildTableBody = (data, columns) => {
    ...
    data.forEach(function (row) {
      ...
      columns.forEach(function (column) {
        ...
        else if(column === "imslaughter.numkun") {
          dataRow.push(row.imslaughter.numkun);
        }
        else if(column === "imslaughter.namefarmer") {
          dataRow.push(row.imslaughter.namefarmer);
        }
  ...
  const printPDF = () => {
    var docDefinition = {
      ...
      content: [
        ...
        {
          text: "รายงานสรุปซากโคผ่าซีก\n\n",
          style: "header",
          alignment: "center",
        },
        table(data, [
          "imslaughter.numkun",
          "imslaughter.namefarmer",
          "barcode",
          "beeftype.nameTH",
          "weightwarm",
          "createdAt",
