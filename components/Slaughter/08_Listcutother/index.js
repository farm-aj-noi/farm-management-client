...
export const QUERYLIST = gql`
  query QUERYLIST($sendAt: String, $status: String, $barcode: String) {
    SearchLumpForCut(sendAt: $sendAt, status: $status, barcode: $barcode) {
      id
      beeftype {
        code
        nameTH
          ...
          >
            ...
            <div className="mb-3" style={{ margin: "auto" }}>
              ...
              >
                ...
                {BeefData &&
                  BeefData.SearchBeeftypeLumpAll.map((prod) => (
              ...
              >
                <option value="">ทั้งหมด</option>
                <option value="5f4468d4f226042dc88ef334">รอตัดแต่ง</option>
                <option value="5f4468e0f226042dc88ef335">ตัดแต่งแล้ว</option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <tbody>
                  {data &&
                    data.SearchLumpForCut.map((prod) =>
            ...
            <div className="mb-3" style={{ margin: "12px auto" }}>
              <Link href="/slaughter/cutother">
                <Gobutton>ไปยังหน้าตัดแต่งก้อนเนื้อ</Gobutton>
              </Link>
            </div>
          </DivFromDown>
        </DivFrom>
