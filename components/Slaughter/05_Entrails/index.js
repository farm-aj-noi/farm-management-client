...
import ListEntrails from "./listentrails";
          ...
          >
            ...
            <div className="mb-3" style={{ margin: "auto" }}>
              ...
              >
                ...
                <option value="5f0fdba202b40c2ab8506568">รอกรอกข้อมูล</option>
                <option value="5f0fdbb402b40c2ab8506569">กรอกข้อมูลแล้ว</option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <tbody>
                  {data &&
                    data.imslaughtersSearchEntrails.map((prod) => (
                      <ListEntrails key={prod.id} imslaughter={prod} />
                    ))}
                </tbody>
              </Table>
            </div>
