...
export const QUERY = gql`
  query  QUERY($startdate: String, $enddate: String){
    Reportdead(startdate: $startdate, enddate: $enddate) {
      numcow
      numkun
      pun
      numfarmer
        ...
        <>
          ...
          >
            ...
            <DivFromDown>
              ...
              >
                {data && data.Reportdead.length > 0 ? (
                  <div>
                    <Pdf prod={data.Reportdead} /> <Excel prod={data.Reportdead} />{" "}
                  </div>
                ) : (
                    ""
                  )}
