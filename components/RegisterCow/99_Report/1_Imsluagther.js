...
import Pdf from "./report_paper/1_Imsluagther";
import Excel from "./report_excel/1_Imsluagther";
...
export const QUERY = gql`
  query QUERY($startdate: String, $enddate: String) {
    Reportgetin(startdate: $startdate, enddate: $enddate) {
      numcow
      numkun
      pun
      numfarmer
            ...
            <DivFromDown>
              ...
              >
                {data && data.Reportgetin.length > 0 ? (
                  <div>
                    <Pdf prod={data.Reportgetin} /> <Excel prod={data.Reportgetin} />{" "}
                  </div>
                ) : (
                  ""
                )}
