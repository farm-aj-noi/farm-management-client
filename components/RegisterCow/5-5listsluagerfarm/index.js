...
const Index = () => {
  ...
  const [selectedStatus, SetStatusChange] = useState("5f0fdb4b02b40c2ab8506563");
  ...
  const { data, loading, error, refetch } = useQuery(QUERY_LISTST, {
    ...
    onCompleted:(data) => {
      ...
      setItemList(data.Selectslaugerfarm)
    ...
    <DivFrom>
      ...
      >
        ...
        <div className="mb-3" style={{ margin: "auto" }}>
              ...
              >
                <option value="5ff2e44a74a6e82d00686276">ส่งเชือด</option>
              </select>
            </div>
...
{/* 
        ...
        <div>
          ...
          >
            ...
            <tbody>
                    {data &&
                      data.Selectslaugerfarm.map((prod) => (
