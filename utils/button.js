...
export const Savebutton = () => {
  return <Icon size={20} icon={save} />;
};

export const Editbutton = () => {
  return <Icon size={20} icon={edit} />;
};

export const Removebutton = () => {
  return <Icon size={20} icon={remove} />;
};

export const Barcodebutton = () => {
  return <Icon size={20} icon={barcode} />;
};

export const Qrcodebutton = () => {
  return <Icon size={20} icon={qrcode} />;
};
